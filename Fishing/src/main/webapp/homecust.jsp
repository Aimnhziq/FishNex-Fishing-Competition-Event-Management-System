...
<section class="home" id="home">
	<div class="home-content">
		<div class="home-text">
			<h1>Welcome <span>
 			<label for="name" class="child" ><c:out value="${sessionScope.CustName}"/></label> </span> <br> Your ID :  <span><label for="id" class="child" ><c:out value="${sessionScope.CustID}"/></label></span> <br> </h1><br>
			<a href="listeventcustcontroller" class="btn">Register Event<i class='bx bxs-plus-square'></i></a>
		</div>
	</div>
</section>
<br><br>
