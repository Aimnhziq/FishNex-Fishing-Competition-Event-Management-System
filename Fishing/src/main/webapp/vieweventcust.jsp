...
<div class="container">
    ...
    <div id="catchList" class="tab-content" action="listcatchcustcontroller" method="post" autocomplete="off">
    <div class="containers">
        <h3>Catch List</h3>
...
<script>
	...
	function showTab(tabId) {
	    ...
	    if (tabId === 'catchList') {
	        ...
	        $.ajax({
	            url: "listcatchcustcontroller?EventID=<c:out value='${c.eventID}'/>",
	            method: "get",
	        ...
	        // Ensure the content is loaded before displaying
	        $.ajax({
	            url: "vieweventcontrollercustnew?EventID=<c:out value='${c.eventID}'/>",
	            method: "get",
	            success: function (response) {
	        ...
	        // Ensure the content is loaded before displaying
	        $.ajax({
	            url: "listcustnewcontroller?EventID=<c:out value='${c.eventID}'/>",
	            method: "get",
	            success: function (response) {
