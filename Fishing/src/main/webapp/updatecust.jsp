...
<header>
  ...
  <div class="wrapper">
    <div class="form-wrapper sign-in">
      <form action="updatecustcontroller" method="post" onsubmit="myFunction()">
        <h2>Profile Detail</h2>
        <div class="input-group">
          <input type="text" name="CustName" value="<c:out value="${sessionScope.CustName}"/>"   minlength="5" maxlength="7" title="Enter username minimum 5 words Only"/>
          <label for="">Username</label>
        </div>
        <div class="input-group">
          <input type="tel" name="CustPhoneNum" value="<c:out value="${sessionScope.CustPhoneNum}"/>" minlength="9" maxlength="10" title="Please enter a 10-digit phone number"/>          
          <label for="">Phone number</label>
        </div>
        <div class="input-group">
            <input type="email" name="CustEmail" value="<c:out value="${sessionScope.CustEmail}"/>"/>
            <label for="">Email</label>
        </div>
        <div class="input-group">
            <input type="password" name="CustPass" value="<c:out value="${sessionScope.CustPass}"/>" minlength="6"/>
