...
<section id="customerTable">
	<div class="container">
		...
		<a href="signupstaff.jsp" class="btn-add-event btnla"><i class='bx bx-plus'></i>Sign Up</a>
		<div class="bx bx-menu" id="menu-icon"></div>
		</div>
		<br><br>
	...
	<thead>
		...
		<tbody >
		<c:forEach items="${staff}" var="c" varStatus="staff">
		<tr>
			...
			<td>
                <button onclick="showStaffModal(${c.staffID})" class="btn-view btnla"><i class='bx bx-show'></i></button>
                <!--<button onclick="openUpdateModal(${c.staffID}, '${c.staffName}', ${c.staffPhoneNum}, '${c.staffEmail}', '${c.staffPass}')" class="btn-update btnla"><i class='bx bx-edit'></i></button> -->
               	<!--  <button class="btn-delete btnla" id="<c:out value='${c.staffID}'/>" onclick="confirmation(this.id)"><i class='bx bx-trash'></i></button>-->
            </td>
		</tr>
		</c:forEach>
		</tbody>
  ...
  <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-content update-modal-content">
                    ...
                    <div class="modal-body update-modal-body">
                        ...
                        <form action="UpdateStaffController" method="post">
                            ...
                            <div class="mb-3">
                                <label for="StaffName" class="form-label update-form-label">Name</label>
                                <input type="text" class="form-control update-form-input" id="StaffName" name="StaffName">
                            </div>
                            <div class="mb-3">
                                <label for="StaffPhoneNum" class="form-label update-form-label">Phone Number</label>
                                <input type="text" class="form-control update-form-input" id="StaffPhoneNum" name="StaffPhoneNum">
                            </div>
                            <div class="mb-3">
                                <label for="StaffEmail" class="form-label update-form-label">Email</label>
                                <input type="email" class="form-control update-form-input" id="StaffEmail" name="StaffEmail">
                            </div>
                            <div class="mb-3">
                                <label for="StaffPass" class="form-label update-form-label">Password</label>
                                <input type="password" class="form-control update-form-input" id="StaffPass" name="StaffPass">
                            </div>
    ...
    <script>
        ...
        function showStaffModal(staffID) {
            $.ajax({
              url: "viewstaffcontroller?StaffID=" + staffID,
     ...
     // Make the close icon functional
        ...
        function openUpdateModal(staffID, staffName, staffPhoneNum, staffEmail, staffPass) {
            $('#staffID').val(staffID);
            $('#StaffName').val(staffName);
            $('#StaffPhoneNum').val(staffPhoneNum);
            $('#StaffEmail').val(staffEmail);
            $('#StaffPass').val(staffPass);
...
/* Styles for the Add Catch button wrapper */
.add-catch-wrapper {
    display: flex;
