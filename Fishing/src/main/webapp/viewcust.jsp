...
<header>
	...
	<div class="nav">
		<a href="logincust.jsp" >LOG OUT<i class='bx bx-log-out' ></i></a>
    ...
    <div class="form-wrapper sign-in">
      <form action="">
        ...
        <div class="input-group">
          <br><br>
          <label for="name">Participants ID :<br> <c:out value="${sessionScope.CustID}"/> </label>
        </div>
        <div class="input-group">
          <br><br>
          <label for="name">Username :<br> <c:out value="${sessionScope.CustName}"/> </label>
        </div>
        <div class="input-group">
          <br><br>
          <label for="phone">Phone number:<br> <c:out value="${sessionScope.CustPhoneNum}"/></label>
        </div>
        <div class="input-group">
            <br><br>
            <label for="email">Email:<br>  <c:out value="${sessionScope.CustEmail}"/></label>
        </div>
        <div class="input-group">
            <br><br>
            <label for="password">Password:<br> <c:out value="${sessionScope.CustPass}"/></label>
        </div>
       
        
        <div class="btn-update"> 
		  <a class="btn2" href="updatecustcontroller?CustID=<c:out value="${sessionScope.CustID}"/>">Update</a> 
		  <a class="btn2" id="<c:out value="${sessionScope.CustID}"/>" onclick="confirmation(this.id)">Delete</a>
		 </div>
