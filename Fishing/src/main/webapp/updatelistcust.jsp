    ...
    <div class="form-wrapper sign-in">
      <form action="updatecustcontroller" method="post">
        ...
        <div class="input-group">
          <input type="text" name="CustName" value="<c:out value="${c.custName}"/>"/>
          <label for="">Username</label>
        </div>
        <div class="input-group">
          <input type="text" name="CustPhoneNum" value="<c:out value="${c.custPhoneNum}"/>"/>          
          <label for="">Phone number</label>
        </div>
        <div class="input-group">
            <input type="text" name="CustEmail" value="<c:out value="${c.custEmail}"/>"/>
            <label for="">Email</label>
        </div>
        <div class="input-group">
            <input type="password" name="CustPass" value="<c:out value="${c.custPass}"/>"/>
