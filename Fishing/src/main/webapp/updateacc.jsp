...
<head>
  ...
  <title>update account staff</title>
...
<header>
  ...
  <div class="wrapper">
    <div class="form-wrapper sign-in">
      <form action="updatestaffcontroller" method="post" onsubmit="myFunction()">
        <h2>Profile Detail</h2>
        <div class="input-group">
          <input type="text" name="StaffName" value="<c:out value="${c.staffName}"/>" minlength="5" maxlength="7" title="Enter username minimum 5 words Only"/>
          <label for="">Username</label>
        </div>
        <div class="input-group">
          <input type="tel" name="StaffPhoneNum" value="<c:out value="${c.staffPhoneNum}"/>"pattern="[0-9]{10}" title="Please enter a 10-digit phone number"/>          
          <label for="">Phone number</label>
        </div>
        <div class="input-group">
            <input type="email" name="StaffEmail" value="<c:out value="${c.staffEmail}"/>"/>
            <label for="">Email</label>
        </div>
        <div class="input-group">
            <input type="password" name="StaffPass" value="<c:out value="${c.staffPass}"/>" minlength="6"/>
