  ...
  <table id="eventTable" class="table table-striped">
    ...
    <tbody>
      <c:forEach items="${event}" var="c" varStatus="event">
        <tr>
          <td><img src="${c.eventPictureBase64}" alt="Event Image" style="width: 100px; height: 75px; object-fit: cover;"></td>
          ...
          <td>
            <a href="vieweventcustcontroller?EventID=<c:out value='${c.eventID}'/>" class="btn-view btnla"><i class='bx bx-show'></i></a><br><br>
            <a href="registerevent.jsp?EventID=<c:out value='${c.eventID}'/>" class="btn-view btnla">REGISTER</a>
          </td>
        </tr>
      </c:forEach>
    </tbody>
